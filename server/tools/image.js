...
register({
  ...
  parameters: {
    ...
    properties: {
      ...
      model: {
        ...
        enum: ['black-forest-labs/flux.1-dev', 'black-forest-labs/flux.1-schnell',
               'black-forest-labs/flux.2-klein-4b', 'stabilityai/stable-diffusion-3-medium',
               'stabilityai/stable-diffusion-xl', 'google/diffusiongemma-26b-a4b-it'],
  ...
  async execute(args) {
    const { prompt, model = 'black-forest-labs/flux.1-dev', width = 1024, height = 1024, steps = 30 } = args;
