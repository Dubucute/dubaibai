...
register({
  name: "chat",
  description:
    "Have a conversation with any LLM model. Use for general Q&A, writing, coding, analysis, and any text-based task.",
  parameters: {
    type: "object",
    properties: {
      model: {
        type: "string",
        description:
          "Model ID to use. Smartest: Nemotron Ultra/Super, DeepSeek V4 Pro, Qwen 3.5, Llama 4. Fastest: DeepSeek V4 Flash, Phi-4 Mini, Step Fun, Gemma 3.",
        enum: [
